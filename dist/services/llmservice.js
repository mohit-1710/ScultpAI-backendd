...
import { errorRecoveryPromptForManimCode } from "./prompt.js";
 ...
 */
export const correctManimCodeWithLLM = async (originalManimCode, errorDetails, // This will contain Flake8 output or Manim stderr
sceneInfo) => {
    if (!config.googleGenerativeAiApiKey || config.googleGenerativeAiApiKey === "MISSING_OR_INVALID_API_KEY_CHECK_ENV") {
