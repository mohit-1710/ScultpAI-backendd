...
import {
  ...
  generateVideoFromStoryboardSchema,
} from '../validators/projectValidators.js'; // Import your Zod schemas
...
router.post(
  '/initiate',
  validate(createProjectIdeaSchema), // Apply Zod validation to the request
 ...
 */
router.post(
  '/:projectId/generate-video',
  validate(generateVideoFromStoryboardSchema), // Validate params and body
  //@ts-ignore
